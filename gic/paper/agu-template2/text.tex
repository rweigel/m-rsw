...
\bibitem[{\textit{{Bedrosian} and {Love}}(2015)}]{Bedrosian2015}
...
\bibitem[{\textit{Boteler}(2015)}]{Boteler2015}
...
\bibitem[{\textit{Chave and Jones}(2012)}]{Chave2012}
...
\bibitem[{\textit{Egbert}(1992)}]{Egbert1992}
...
\bibitem[{\textit{Egbert and Booker}(1986)}]{Egbert1986}
...
\bibitem[{\textit{Eisel and Egbert}(2001)}]{Eisel2001}
...
\bibitem[{\textit{Fernberg}(2012)}]{Fernberg2012}
...
\bibitem[{\textit{Fujii et~al.}(2015)\textit{Fujii, Ookawa, Nagamachi, and
  Owada}}]{Fujii2015}
...
\bibitem[{\textit{Jones et~al.}(1989)\textit{Jones, Chave, Egbert, Auld, and
  Bahr}}]{Jones1989}
...
\bibitem[{\textit{Kelbert et~al.}(2011)\textit{Kelbert, Egbert, and
  Schultz}}]{Kelbert2011}
...
\bibitem[{\textit{Lehtinen and Pirjola}({1985})}]{Lehtinen1985}
...
\bibitem[{\textit{Love and Swidinsky}(2014)}]{Love2014}
...
McMechan, G.~A., and I.~Barrodale (1985), Processing electromagnetic data in
  ...
  277--293, \doi{10.1111/j.1365-246x.1985.tb01363.x}.

\bibitem[{\textit{Meltzer}(2003)}]{Meltzer2003}
Meltzer, A. (2003), Earthscope: Opportunities and challenges for earth-science
  ...
  \doi{10.1190/1.1564533}.

\bibitem[{\textit{NERC}(2015)}]{NERC2015}
NERC (2015), {NERC} {P}roject 2013-03 - benchmark geomagnetic disturbance event
  description.

\bibitem[{\textit{Pulkkinen et~al.}(2007)\textit{Pulkkinen, Pirjola, and
...
Pulkkinen, A., R.~Pirjola, and A.~Viljanen (2007), Determination of ground
  ...
  Space}, \textit{59}(9), 999--1006, \doi{10.1186/bf03352040}.

\bibitem[{\textit{Pulkkinen et~al.}(2010)\textit{Pulkkinen, Kataoka, Watari,
  and Ichiki}}]{Pulkkinen2010}
...
\bibitem[{\textit{Pulkkinen et~al.}(2012)\textit{Pulkkinen, Bernabeu, Eichner,
...
Pulkkinen, A., E.~Bernabeu, J.~Eichner, C.~Beggan, and A.~W.~P. Thomson (2012),
  ...
  \textit{Space Weather}, \textit{10}(4), \doi{10.1029/2011sw000750}.

\bibitem[{\textit{Schultz}(2009)}]{Schultz2009}
Schultz, A. (2009), {EMScope}: A continental scale magnetotelluric observatory
  ...
  \doi{10.2481/dsj.ss\_igy-009}.

\bibitem[{\textit{Schultz et~al.}(2016. Retrieved from the IRIS database on May
  3rd, 2016)\textit{Schultz, Egbert, Kelbert, Peery, Clote, Fry, Erofeeva, and
...
Schultz, A., G.~D. Egbert, A.~Kelbert, T.~Peery, V.~Clote, B.~Fry, S.~Erofeeva,
  ...
  \textit{doi:10.17611/DP/EMTF/USARRAY/TA}, \doi{10.17611/DP/EMTF/USARRAY/TA}.

\bibitem[{\textit{{Simpson} and {Bahr}}(2005)}]{Simpson2005}
{Simpson}, F., and K.~{Bahr} (2005), \textit{{Practical Magnetotellurics}}, 270
  pp., Cambridge University Press, \doi{10.1017/cbo9780511614095}.

\bibitem[{\textit{Sims et~al.}(1971)\textit{Sims, Bostick, and
  Smith}}]{Sims1971}
Sims, W.~E., F.~X. Bostick, and H.~W. Smith (1971), The estimation of
  magnetotelluric impedance tensor elements from measured data,
  \textit{Geophysics}, \textit{36}(5), 938--942, \doi{10.1190/1.1440225}.

\bibitem[{\textit{Tzschoppe and Huber}(2009)}]{Tzschoppe2009}
Tzschoppe, R., and J.~B. Huber (2009), Causal discrete-time system
  ...
  \textit{20}(6), 604--616, \doi{10.1002/ett.1320}.

\bibitem[{\textit{{Viljanen} et~al.}(2012)\textit{{Viljanen}, {Pirjola}, {Wik},
...
{Viljanen}, A., R.~{Pirjola}, M.~{Wik}, A.~{{\'A}d{\'a}m}, E.~{Pr{\'a}cser},
  ...
  Climate}, \textit{2}(27), A17, \doi{10.1051/swsc/2012017}.

\bibitem[{\textit{{Viljanen} et~al.}(2014)\textit{{Viljanen}, {Pirjola},
...
{Viljanen}, A., R.~{Pirjola}, E.~{Pr{\'a}cser}, J.~{Katkalov}, and M.~{Wik}
  ...
  Climate}, \textit{4}(27), A09, \doi{10.1051/swsc/2014006}.

\bibitem[{\textit{Wait}(1954)}]{Wait1954}
...
\bibitem[{\textit{Wei et~al.}(2013)\textit{Wei, Homeier, and Gannon}}]{Wei2013}
Wei, L.~H., N.~Homeier, and J.~L. Gannon (2013), Surface electric fields for
  ...
  \textit{11}(8), 451--462, \doi{10.1002/swe.20073}.
