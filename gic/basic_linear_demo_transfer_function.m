...
addpath('../time');
addpath('../stats');
base = './figures/basic_linear_demo_transfer_function_';
...
figure(2);clf;
    ...
    lh = legend(' Actual Response to $\delta(t)$',...
                ' Predicted Response to $\delta(t)$',...
                ' $\dot{x}(t)+x(t)/\tau_c = \delta (t)$',...
                'Location','North');
